...
![](/static/posts/2026-04-02-comm-signal-performance/throughput.png)

물리 단계에서 수율을 평가하는 방법으로는, 물리적인 거리 $d$ 를 특정한 신호 비트가 얼마나 빨리, 속도 $v_\text{sig}$ 혹은 전송시간 $t_\text{sig}$ 를 사용하여, 이동할 수 있는지 판단하는 것이 가능할 것이다.  

![](/static/posts/2026-04-02-comm-signal-performance/transfer-speed.png)
...
![](/static/posts/2026-04-02-comm-signal-performance/shannon.jpeg)  
