...
분석하고자 하는 항목이 이진적이지 않은 구성을 가지고 있을 수도 있다. 만약 세 가지 이상의 범주로 구성된 항목이 있어 이 분석을 사용하기 어렵다면, [카이제곱 검정(Chi-square test)](/posts/2026-04-09-cross-tabs-and-chi-sqrt-test)을 사용하여 범주 간의 차이를 검정할 수 있다.
