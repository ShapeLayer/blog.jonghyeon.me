...
# 2024 상반기 전남대학교 PIMM 알고리즘 파티를 마무리하며

안녕하세요, &lt;2024 상반기 전남대학교 PIMM 알고리즘 파티&gt; 대회(24년 대회, 핌파티)의 총괄을 맡은 박종현, belline0124입니다. 이번 대회도 잘 마무리되어서 진심으로 기쁩니다. 특히 저번 대회보다 조금 "우당탕탕"하게 준비한 부분이 있어 조금 불안했는데 정말 다행입니다.
...
24년이 되고, 전역하는 기차에서 핌파티 추진을 본격적으로 알렸습니다. 동시에 검수진 모집을 시작했는데, 정말 감사하게도 23년 대회 TF에서 고생해주셨던 분들도 다시 한번 TF에 참여해주셨습니다.
...
![_DSF2418.jpeg](/static/posts/2024-03-13-rewinding-24-1-pimm-party/_DSF2418.jpeg)
...
재학생 중에 현역으로 PS 즐기는 사람들이 TF 사람들밖에 없기도 하고, 23년 대회에서도 집계된 재학생 참가자가 서른명도 되지 않았으므로 애초에 이 대회의 대상은 백준 유저지, 재학생이 아닙니다.
...
포스터는 23년 대회 &lt;C. 인기투표&gt; 문제 그림을 만들어준 강도희 씨한테 다시 한번 도움을 받았습니다. 처음엔 조언만 좀 받으려고 도움을 부탁했는데, 어느 순간 자기 일처럼 본격적으로 이것저것 해주는걸 보고 너무너무 고마웠습니다.
...
카드 뉴스는 핌 인스타그램 담당자인 박현솔 님과 TF의 [김근성(@onsbtyd)](https://www.acmicpc.net/user/onsbtyd) 씨가 담당해주셨습니다. 두분 모두 감사합니다.
...
검수 자체도 더 빡빡하게 이루어져서, 각종 논리, 컨벤션, 표현을 체크하고 또 체크하고.. 같은 부분도 수 없이 체크했습니다. 아직도 "~는 정의되지 않았습니다. 정의를 넣거나 표현을 수정해야합니다."는 기억에서 잊히질 않습니다.
...
다행히도 &lt;전역 역전&gt;에 질문이나 오류가 없어서 큰 문제는 없었습니다.
...
준비 기간을 오래 잡고 갔는데도, 결과물은 그에 비해 막 만족스럽지 않은 것 같습니다. 대회 자체만 놓고 보면 큰 문제 없이 난이도 커브도 그럭저럭 잘 그려졌으니 꽤 성공적이라고 볼 수도 있습니다.
