...
그렇다면, 처음부터 이 수를 분모, 10억에 나누어 떨어지게 생성하여 등장 횟수를 균등하게 만들어 해결할 수 있습니다. 스트리밍에서도 남은 것을 버린다는 표현이 있었는데, 등장하는 수를 0부터 39.99..억 사이의 숫자로 제한한다는 의미로 해석할 수 있을 것 같습니다.  
...
이것을 구현하는 방법은 여러 개 있을 수 있겠습니다만, 생각할 수 있는 가장 간단한 방법은 39.99..억보다 큰 숫자가 나오면 39.99억 아래의 수가 나올 때까지 다시 난수를 생성하는 것입니다.  
