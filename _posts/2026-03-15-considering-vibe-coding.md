...
시간이 지나면서 이윽고 AI가 점점 나 자체를 대체하는 듯한 기분이 들었다. 내게 있어서 IT 산업을 견제하고 규제하려고 시도하는 기성 산업이나 사업자, 그리고 노동자들은, 18세기 영국의 숙련공들이나 마차업자였다. 결국에는 러다이트 운동으로 이어지거나 적기 조례가 만들어지는데 이바지하는. 종종 인터넷에서 「없어질 직업을 보호해봐야 사회 발전만 정체된다」는 표현을 보곤 한다. IT 산업의 시도를 기성 사회가 규제로서 좌절시킨 사례가 이어지고 있으므로, 나는 이 의견에 다소 동조하고 있었다.ー물론 기성 사회와의 상생책 없이 변화가 가져올 부정적 영향을 외면한 채 IT 산업의 자동화와 연결성으로, 그저 원래의 것을 파괴하기만 하거나 대체해버리는 것에 동의한다는 것은 아니다.ー  

그리고 이제는 내가 수공업 숙련공, 마차업자, 전화 교환원, 버스 안내양, 혹은 우버와 경쟁하는 택시기사의 위치에 놓이게 되었다.  
